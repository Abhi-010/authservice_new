package dev.abhi.userservice.userservice.Security.services;

import java.util.HashSet;
import java.util.Set;

import dev.abhi.userservice.userservice.Security.models.AuthorizationConsent;
import dev.abhi.userservice.userservice.Security.repositories.AuthorizationConsentRepository;
